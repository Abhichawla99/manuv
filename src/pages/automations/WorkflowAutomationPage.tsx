    ...
    return (
        <div className="relative min-h-screen bg-black text-white">
            <SEO
                ...
                description="Custom workflow automation solutions. Automate business workflows, processes, and operations with AI-powered workflow automation systems."
                keywords="workflow automation, business workflow automation, automated workflows, workflow automation software, process workflow automation"
                canonical="https://manuv.co/automations/workflow-automation"
            />
            <section className="px-6 md:px-10 lg:px-16 py-32 bg-gradient-to-b from-black via-gray-900/50 to-black">
                <div className="max-w-7xl mx-auto">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl">
                        ...
                        <p className="text-xl md:text-2xl font-light text-white/70 mb-8 leading-relaxed">Custom workflow automation. Automate business workflows and processes with AI-powered systems.</p>
